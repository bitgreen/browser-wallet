...
async function mainloop() {
  ...
  apiv = await ApiPromise.create({ provider: wsProvider,types:
   ...
   let address='5FBqW9YiSQKnptUZJALJ1PhXPCeVbeLkjGXZPieUSDXGMTP8';
   console.log("Get Nominator:");
   console.log(await get_nominator(address));
   console.log("Get Nominator:");
   console.log(await get_nominator(keyspair.address));
